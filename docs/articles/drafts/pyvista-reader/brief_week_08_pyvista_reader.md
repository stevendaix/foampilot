# Brief — Semaine 8 : "Reader direct OpenFOAM → PyVista : architecture et extraction de quantités physiques"

**Objectif** : Expliquer comment foampilot lit les résultats OpenFOAM directement dans PyVista, sans conversion, et extrait des quantités physiques (y+, τ_w, strain rate).
**Angle** : Architecture logicielle, performance, physique intégrée.
...
Storytelling : Vous avez une simulation qui tourne. Vous voulez visualiser les résultats. Vous lancez `foamToVTK`, attendez 10 minutes, puis ouvrez Paraview. Mais si vous pouviez visualiser directement depuis Python, sans conversion ?
...
### Section 3 — Sous le capot : architecture du reader
...
### Section 4 — Extraire des quantités physiques
...
CTA : *"Maintenant que vous pouvez lire et visualiser vos résultats, je vous montre comment générer des rapports professionnels avec LaTeX et Typst."*

---

## Code à préparer

- [ ] Script reader direct simple
- [ ] Script extraction y+ avec validation
- [ ] Script extraction τ_w avec validation analytique
- [ ] Script CHTDirectReader
- [ ] Benchmark performance

## Images à préparer

- [ ] Schéma architecture du reader
- [ ] Graphique de performance (temps vs nombre de cellules)
- [ ] Capture d'écran PyVista (visualisation U)
- [ ] Heatmap y+ sur les parois
- [ ] Graphique mémoire utilisée
