...
from foampilot.extensions.urban.simplification.cfd_simplifier import CFDGeometry
from foampilot.extensions.urban.model.domain import CFDDomain, WindFrame
