"""OpenFOAM 13 multicomponentFluid/counterFlowFlame2DLTS_GRI_TDAC via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multicomponentFluid/counterFlowFlame2DLTS_GRI_TDAC")
