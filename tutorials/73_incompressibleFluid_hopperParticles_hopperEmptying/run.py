"""OpenFOAM 13 hopperParticles/hopperEmptying through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/hopperParticles/hopperEmptying")
