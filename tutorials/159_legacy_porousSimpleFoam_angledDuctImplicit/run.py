"""OpenFOAM 13 legacy porousSimpleFoam/angledDuctImplicit via FoamPilot."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/legacy/incompressible/porousSimpleFoam/angledDuctImplicit"
)
...
def main() -> None:
    ...
    solver.solver_name = "porousSimpleFoam"
    ...
    solver.run_command(
        [str(OF13_BIN / "porousSimpleFoam")],
        log_filename="log.porousSimpleFoam",
    )
