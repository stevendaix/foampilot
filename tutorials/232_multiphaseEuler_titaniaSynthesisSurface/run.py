"""OpenFOAM 13 multiphaseEuler/titaniaSynthesisSurface via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multiphaseEuler/titaniaSynthesisSurface")
...
def main() -> None:
    ...
    solver.import_reference_asset(
        Path("/opt/openfoam13/tutorials/resources/blockMesh/titaniaSynthesis"),
        case_path / "system/titaniaSynthesis",
    )
    run_of13(
        solver,
        "blockMesh",
        "-dict",
        "system/titaniaSynthesis",
        tag="blockMesh",
    )
