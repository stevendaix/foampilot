"""OpenFOAM 13 incompressibleFluid/pitzDailyLESDevelopedInlet through FoamPilot only."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/incompressibleFluid/pitzDailyLESDevelopedInlet"
)
