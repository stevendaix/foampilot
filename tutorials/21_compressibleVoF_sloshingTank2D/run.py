"""OpenFOAM 13 compressibleVoF/sloshingTank2D through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/compressibleVoF/sloshingTank2D")
BLOCK_MESH = Path("/opt/openfoam13/tutorials/resources/blockMesh/sloshingTank2D")
BLOCK_MESH_INCLUDE = Path("/opt/openfoam13/tutorials/resources/blockMesh/sloshingTank")
