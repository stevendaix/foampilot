"""OpenFOAM 13 incompressibleFluid/oscillatingInlet through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/oscillatingInlet")
