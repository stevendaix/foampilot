"""OpenFOAM 13 incompressibleVoF/sloshingCylinder through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleVoF/sloshingCylinder")
...
def import_reference_case(solver: Solver, case_path: Path) -> None:
    """Import the OF13 case inputs without invoking shell operations."""
...
def main() -> None:
    ...
    solver.run_command(
        [str(OF13_BIN / "snappyHexMesh")], log_filename="log.snappyHexMesh"
    )
    solver.run_command(
