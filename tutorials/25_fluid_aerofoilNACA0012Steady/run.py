"""OpenFOAM 13 fluid/aerofoilNACA0012Steady through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/fluid/aerofoilNACA0012Steady")
GEOMETRY_ASSET = Path("/opt/openfoam13/tutorials/resources/geometry/NACA0012.obj.gz")
