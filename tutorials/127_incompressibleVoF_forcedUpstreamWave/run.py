"""OpenFOAM 13 incompressibleVoF/forcedUpstreamWave through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleVoF/forcedUpstreamWave")
...
def main() -> None:
    ...
    solver.run_command(
        ["mpirun", "--oversubscribe", "-np", "6", "foamRun", "-solver", "incompressibleVoF", "-parallel"],
        log_filename="log.foamRun.parallel",
    )
