"""OpenFOAM 13 potentialFoam/cylinder via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/potentialFoam/cylinder")
...
def main() -> None:
    ...
    run_of13(solver, "potentialFoam", "-functionObjects", "-writePhi", "-writep", tag="potentialFoam")
