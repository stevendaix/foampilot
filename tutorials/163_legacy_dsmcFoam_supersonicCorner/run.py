"""OpenFOAM 13 legacy dsmcFoam/supersonicCorner via FoamPilot."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/legacy/lagrangian/dsmcFoam/supersonicCorner"
)
...
def import_reference_case(solver: Solver, case_path: Path) -> None:
    """Import the complete OF13 DSMC corner case through FoamPilot managers."""
