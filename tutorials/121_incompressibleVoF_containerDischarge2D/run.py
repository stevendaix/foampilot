"""OpenFOAM 13 incompressibleVoF/containerDischarge2D through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleVoF/containerDischarge2D")
