"""OpenFOAM 13 multiphaseEuler/mixerVessel2D via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multiphaseEuler/mixerVessel2D")
...
def import_reference_case(solver: Solver, case_path: Path) -> None:
    ...
    solver.import_reference_asset(
        Path("/opt/openfoam13/tutorials/resources/blockMesh/mixerVessel2D"),
        case_path / "system/mixerVessel2D",
    )
...
def main() -> None:
    ...
    run_of13(solver, "blockMesh", "-dict", "system/mixerVessel2D", tag="blockMesh")

    run_of13(solver, "createBaffles", tag="createBaffles")
    run_of13(solver, "splitBaffles", tag="splitBaffles")
    run_of13(solver, "createNonConformalCouples", "nonCouple1", "nonCouple2", tag="createNonConformalCouples")
