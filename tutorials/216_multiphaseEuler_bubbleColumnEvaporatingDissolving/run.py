"""OpenFOAM 13 multiphaseEuler/bubbleColumnEvaporatingDissolving via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multiphaseEuler/bubbleColumnEvaporatingDissolving")
