"""OpenFOAM 13 incompressibleFluid/pitzDailySteadyExperimentalInlet through FoamPilot only."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/incompressibleFluid/pitzDailySteadyExperimentalInlet"
)
