"""OpenFOAM 13 incompressibleVoF/sloshingTank2D3DoF through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleVoF/sloshingTank2D3DoF")
MESH_REFERENCE = Path("/opt/openfoam13/tutorials/resources/blockMesh/sloshingTank2D")
...
def import_reference_case(solver: Solver, case_path: Path) -> None:
    """Import OF13 dictionaries and fields through FoamPilot APIs."""
