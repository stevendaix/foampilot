"""OpenFOAM 13 incompressibleDenseParticleFluid/injectionChannel through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleDenseParticleFluid/injectionChannel")
