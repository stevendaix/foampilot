"""OpenFOAM 13 incompressibleFluid/blockedChannel through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/blockedChannel")
...
def main() -> None:
    ...
    solver.system.run_utility(
        "foamPostProcess", args=["-func", "generateAlphas"], log_filename="log.generateAlphas"
    )
