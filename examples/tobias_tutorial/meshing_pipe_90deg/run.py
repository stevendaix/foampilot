"""Tobias Holzmann 90-degree pipe meshing, generated with FoamPilot."""
...
def write_case():
    ...
    writer = OpenFOAMDictAddFile(object_name="tobias_pipe_90deg")
...
def run():
    ...
    print(f"Validated 90-degree pipe meshing run: {CASE}")
