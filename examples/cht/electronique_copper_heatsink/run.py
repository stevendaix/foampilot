#!/usr/bin/env python3
"""
Variant CHT Électronique — Dissipateur en cuivre

Compare avec le cas baseline (aluminium) pour étudier
l'impact du matériau du dissipateur sur la résistance thermique.
...
gmsh_model_name = "electronique_copper_heatsink"
