#!/usr/bin/env python3
"""
Variant CHT Électronique — Haute vitesse (2 m/s)

Compare avec le cas baseline (1 m/s) pour étudier
l'impact de la vitesse d'entrée sur le refroidissement.
...
gmsh_model_name = "electronique_high_velocity"
...
print("\n" + "=" * 60)
print("Cas CHT Électronique (haute vitesse) créé avec succès")
print("=" * 60)
