...
for dim, tag in surfs:
    if tag in [61, 62]:
        ...
        print(f"    Elements: etypes={etypes}, n={sum(len(e) for e in enodes)}")

gmsh.write("debug_merged_2d.msh")
print(f"\n2D mesh saved to debug_merged_2d.msh")
