...
BASE=Path('/home/ubuntu/vmtk_audit_extract'); SRC=BASE/'medical_build_complex_source_cap4'/'medical_build_input.vtp'; ROOT=BASE/'complex_analysis_raw_package'; OUT=ROOT/'openfoam_surface_patches_clean'; TRI=OUT/'constant'/'triSurface'; TRI.mkdir(parents=True,exist_ok=True)
def read_vtp(path):
