...
BASE=Path('/home/ubuntu/vmtk_audit_extract'); ROOT=BASE/'complex_analysis_raw_package'; PATCH=ROOT/'openfoam_surface_patches'; CASE=PATCH/'case_motorbike_style'; (CASE/'system').mkdir(parents=True,exist_ok=True); (CASE/'constant'/'triSurface').mkdir(parents=True,exist_ok=True)
