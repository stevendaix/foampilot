...
BASE=Path(__file__).resolve().parents[2]; ROOT=BASE/'complex_analysis_raw_package'; OUT=ROOT/'openfoam_surface_patches'; TRI=OUT/'constant'/'triSurface'; TRI.mkdir(parents=True,exist_ok=True)
