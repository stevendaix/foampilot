...
ROOT=Path(__file__).resolve().parents[2] / 'examples/medical_build/openfoam_case/constant/triSurface'
SRC=Path(__file__).resolve().parents[2] / 'case_complex/complex_vmtk_reference_clean.stl'
