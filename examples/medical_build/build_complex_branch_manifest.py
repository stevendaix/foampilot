...
ROOT=Path(__file__).resolve().parents[2]; SRC=Path(__file__).resolve().parents[2] / 'case_complex'; OUT=ROOT/'examples/medical_build/outputs'
CAPS=Path(__file__).resolve().parents[2] / 'case_complex/openfoam_surface_patches/patch_manifest.json'
def main():
