...
p=Path('/home/ubuntu/vmtk_audit_extract/complex_analysis_raw_package/openfoam_surface_patches/aorta_surface_patches.vtp'); out=Path('/home/ubuntu/foampilot_pr_repo/examples/medical_build/outputs')
