"""OpenFOAM 13 mesh/snappyHexMesh/flange through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/mesh/snappyHexMesh/flange")
RESOURCE_GEOMETRY = Path("/opt/openfoam13/tutorials/resources/geometry/flange.stl.gz")
...
def import_reference_case(solver: Solver, case_path: Path) -> None:
    ...
    solver.import_reference_asset(
        RESOURCE_GEOMETRY, case_path / "constant/geometry/flange.stl.gz"
    )
