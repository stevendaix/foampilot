"""OpenFOAM 13 multiRegion/CHT/multiphaseCoolingCylinder2D via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multiRegion/CHT/multiphaseCoolingCylinder2D")
