"""OpenFOAM 13 multicomponentFluid/smallPoolFire3D via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multicomponentFluid/smallPoolFire3D")
...
def main() -> None:
    ...
    run_of13(solver, "createPatch", tag="createPatch")
    run_of13(solver, "decomposePar", "-force", tag="decomposePar.force")
    run_parallel(solver, "foamRun", tag="foamRun.parallel")
    run_of13(solver, "reconstructPar", tag="reconstructPar")
