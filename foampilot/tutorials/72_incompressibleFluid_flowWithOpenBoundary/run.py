"""OpenFOAM 13 incompressibleFluid/flowWithOpenBoundary through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/flowWithOpenBoundary")
