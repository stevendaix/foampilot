"""OpenFOAM 13 hopperParticles/hopperInitialState through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/hopperParticles/hopperInitialState")
