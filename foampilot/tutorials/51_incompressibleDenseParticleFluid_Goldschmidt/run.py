"""OpenFOAM 13 incompressibleDenseParticleFluid/Goldschmidt through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleDenseParticleFluid/Goldschmidt")
