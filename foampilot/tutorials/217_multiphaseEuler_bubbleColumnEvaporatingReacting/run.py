"""OpenFOAM 13 multiphaseEuler/bubbleColumnEvaporatingReacting via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multiphaseEuler/bubbleColumnEvaporatingReacting")
