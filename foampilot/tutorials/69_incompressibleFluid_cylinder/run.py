"""OpenFOAM 13 incompressibleFluid/cylinder through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/cylinder")
...
def main() -> None:
    ...
    solver.system.run_utility("mirrorMesh", log_filename="log.mirrorMesh")
