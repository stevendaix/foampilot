"""OpenFOAM 13 multiphaseEuler/wallBoilingPolydisperseTwoGroups via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multiphaseEuler/wallBoilingPolydisperseTwoGroups")
...
def main() -> None:
    ...
    run_of13(solver, "foamPostProcess", "-latestTime", "-func", "graphCell(name=graph,start=(3.4901 0 0),end=(3.4901 0.0096 0),fields=(alpha.gas alpha.gas2 T.liquid T.gas T.gas2 d.gas d.gas2))", tag="graphCell.latestTime")
