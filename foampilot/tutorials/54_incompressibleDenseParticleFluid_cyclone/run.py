"""OpenFOAM 13 incompressibleDenseParticleFluid/cyclone through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleDenseParticleFluid/cyclone")
