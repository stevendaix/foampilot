"""OpenFOAM 13 mesh/blockMesh/pipe through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/mesh/blockMesh/pipe")
...
def main() -> None:
    ...
    for asset in ("curve.obj", "curve2.vtk"):
        solver.constant.import_reference_file(
            REFERENCE / "constant/geometry" / asset,
            filename=Path("geometry") / asset,
        )
