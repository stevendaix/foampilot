"""OpenFOAM 13 incompressibleFluid/rotor2D through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/rotor2D")
BLOCKMESH_REFERENCE = Path("/opt/openfoam13/tutorials/resources/blockMesh/rotor2D")
