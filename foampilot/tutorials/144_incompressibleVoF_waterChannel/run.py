"""OpenFOAM 13 incompressibleVoF/waterChannel through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleVoF/waterChannel")
...
def main() -> None:
    ...
    for name in ("blockMesh", "setFields"):
        solver.run_command(
