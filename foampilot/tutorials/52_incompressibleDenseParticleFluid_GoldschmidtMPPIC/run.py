"""OpenFOAM 13 incompressibleDenseParticleFluid/GoldschmidtMPPIC through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleDenseParticleFluid/GoldschmidtMPPIC")


def main() -> None:
    case_path = Path.cwd()
    solver = Solver(case_path)
    solver.solver_name = "incompressibleDenseParticleFluid"
    ...
    solver.run_simulation(nb_proc=1, log_filename="log.incompressibleDenseParticleFluid")
