"""OpenFOAM 13 shockFluid/shockTube via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/shockFluid/shockTube")
...
def main() -> None:
    ...
    run_of13(solver, "foamPostProcess", "-func", "sample", tag="foamPostProcess.sample")
