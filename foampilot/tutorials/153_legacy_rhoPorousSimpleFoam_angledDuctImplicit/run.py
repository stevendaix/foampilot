"""OpenFOAM 13 legacy rhoPorousSimpleFoam/angledDuctImplicit via FoamPilot."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/legacy/compressible/rhoPorousSimpleFoam/angledDuctImplicit"
)
