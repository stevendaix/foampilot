"""OpenFOAM 13 incompressibleFluid/impeller through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/impeller")
...
def main() -> None:
    ...
    solver.system.run_utility(
        "createNonConformalCouples", log_filename="log.createNonConformalCouples"
    )
