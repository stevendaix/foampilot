"""OpenFOAM 13 incompressibleVoF/mixerVesselHorizontal2D through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleVoF/mixerVesselHorizontal2D")
...
def main() -> None:
    ...
    solver.run_command(["blockMesh", "-dict", str(MESH_REFERENCE)], log_filename="log.blockMesh")
    ...
    solver.run_command(["createNonConformalCouples", "nonCouple1", "nonCouple2"], log_filename="log.createNonConformalCouples")
