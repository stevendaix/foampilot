"""OpenFOAM 13 multiRegion/CHT/VoFcoolingCylinder2D via FoamPilot."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/multiRegion/CHT/VoFcoolingCylinder2D"
)
...
def import_reference_case(solver: Solver, case_path: Path) -> None:
    """Import global, regional and initial-field data through FoamPilot."""
...
def main() -> None:
    ...
    solver.run_command(
        [str(OF13_BIN / "setFields"), "-region", "fluid"],
        log_filename="log.setFields.fluid",
    )
    solver.run_command(
