"""OpenFOAM 13 legacy electrostaticFoam/chargedWire via FoamPilot."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/legacy/electromagnetics/electrostaticFoam/chargedWire"
)
...
def main() -> None:
    ...
    solver.solver_name = "electrostaticFoam"
    ...
    solver.run_command(
        [str(OF13_BIN / "electrostaticFoam")],
        log_filename="log.electrostaticFoam",
    )
