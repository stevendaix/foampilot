"""OpenFOAM 13 multiRegion/film/hotBoxes via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multiRegion/film/hotBoxes")
...
def main() -> None:
    ...
    command(solver, "blockMesh", "-region", "fluid", tag="blockMesh.fluid")
    command(
        solver,
        "decomposePar",
        "-region",
