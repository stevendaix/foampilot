"""OpenFOAM 13 legacy mdEquilibrationFoam/periodicCubeWater via FoamPilot."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/legacy/lagrangian/mdEquilibrationFoam/periodicCubeWater"
)
...
def main() -> None:
    ...
    solver.run_command(
        [str(OF13_BIN / "mdInitialise")], log_filename="log.mdInitialise"
    )
    solver.run_command(
