"""OpenFOAM 13 multicomponentFluid/verticalChannelSteady via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multicomponentFluid/verticalChannelSteady")
...
def main() -> None:
    ...
    run_of13(solver, "potentialFoam", tag="potentialFoam")
    solver.remove_case_asset(case_path / "0" / "phi")

    run_of13(solver, "foamRun", tag="foamRun")
    run_of13(solver, "steadyParticleTracks", tag="steadyParticleTracks")
