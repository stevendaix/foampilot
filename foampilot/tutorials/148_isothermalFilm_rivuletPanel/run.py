"""OpenFOAM 13 isothermalFilm/rivuletPanel through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/isothermalFilm/rivuletPanel")
...
def main() -> None:
    ...
    solver.solver_name = "isothermalFilm"
    ...
    solver.run_command(
        [str(OF13_BIN / "foamRun"), "-solver", "isothermalFilm"],
        log_filename="log.isothermalFilm",
    )
