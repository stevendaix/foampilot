"""OpenFOAM 13 incompressibleFluid/T3A through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleFluid/T3A")
...
def main() -> None:
    ...
    for source in (REFERENCE / "validation").rglob("*"):
        if source.is_file():
