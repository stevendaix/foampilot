"""OpenFOAM 13 multicomponentFluid/verticalChannel via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multicomponentFluid/verticalChannel")
...
def main() -> None:
    ...
    run_of13(solver, "particleTracks", tag="particleTracks")
