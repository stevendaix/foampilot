"""OpenFOAM 13 legacy porousSimpleFoam/angledDuctExplicit via FoamPilot."""
...
REFERENCE = Path(
    "/opt/openfoam13/tutorials/legacy/incompressible/porousSimpleFoam/angledDuctExplicit"
)
