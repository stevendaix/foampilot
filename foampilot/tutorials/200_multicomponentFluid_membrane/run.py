"""OpenFOAM 13 multicomponentFluid/membrane via FoamPilot."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/multicomponentFluid/membrane")
...
def main() -> None:
    ...
    run_of13(solver, "snappyHexMesh", "-overwrite", tag="snappyHexMesh")
