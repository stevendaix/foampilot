"""OpenFOAM 13 incompressibleVoF/floatingObjectWaves through FoamPilot only."""
...
REFERENCE = Path("/opt/openfoam13/tutorials/incompressibleVoF/floatingObjectWaves")
...
def main() -> None:
    ...
    solver.run_command(["subsetMesh", "-noFields"], log_filename="log.subsetMesh")
