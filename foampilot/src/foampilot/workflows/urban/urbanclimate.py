...
class UrbanClimateCase:
    ...
    def _region_specs(self):
        from foampilot.workflows.urban.urbanclimate_native import RegionSpec
    ...
    def write_case(
        ...
        *,
        ...
        from foampilot.workflows.urban.urbanclimate_native import UrbanClimateNativeCaseBuilder
        properties = {
