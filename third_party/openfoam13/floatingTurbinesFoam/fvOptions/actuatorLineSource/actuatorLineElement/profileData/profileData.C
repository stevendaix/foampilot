...
static Foam::List<Foam::scalar> profileDegToRad
(
    const Foam::List<Foam::scalar>& values
)
{
    Foam::List<Foam::scalar> converted(values.size());
    forAll(values, i)
    {
        converted[i] = Foam::degToRad(values[i]);
    }
    return converted;
}
...
Foam::List<Foam::scalar> Foam::profileData::readAngleOfAttackList(word keyword)
{
...
void Foam::profileData::calcNormalCoeffSlope()
{
    ...
    List<scalar> alphaList = profileDegToRad(angleOfAttackList(0, alphaHigh));
...
Foam::List<Foam::scalar> Foam::profileData::subList
(
...
const Foam::List<Foam::scalar>& Foam::profileData::angleOfAttackList()
{
    return angleOfAttackList_;
}


const Foam::List<Foam::scalar>& Foam::profileData::liftCoefficientList()
{
    return liftCoefficientList_;
}


const Foam::List<Foam::scalar>& Foam::profileData::dragCoefficientList()
{
    return dragCoefficientList_;
}


const Foam::List<Foam::scalar>& Foam::profileData::momentCoefficientList()
{
    return momentCoefficientList_;
}


Foam::List<Foam::scalar> Foam::profileData::angleOfAttackList
(
    scalar alphaDegStart,
    scalar alphaDegStop
)
...
Foam::List<Foam::scalar> Foam::profileData::liftCoefficientList
(
    scalar alphaDegStart,
    scalar alphaDegStop
)
...
Foam::List<Foam::scalar> Foam::profileData::dragCoefficientList
(
    scalar alphaDegStart,
    scalar alphaDegStop
)
...
Foam::List<Foam::scalar> Foam::profileData::momentCoefficientList
(
    scalar alphaDegStart,
    scalar alphaDegStop
)
...
Foam::List<Foam::scalar> Foam::profileData::normalCoefficientList
(
    scalar alphaDegStart,
    scalar alphaDegStop
)
...
Foam::List<Foam::scalar> Foam::profileData::chordwiseCoefficientList
(
    scalar alphaDegStart,
    scalar alphaDegStop
)
