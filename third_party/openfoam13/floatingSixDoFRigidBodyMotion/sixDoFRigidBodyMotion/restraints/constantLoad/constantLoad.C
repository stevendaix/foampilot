...
)
{
    ...
    sDoFRBMRCoeffs_.lookup("applicationPt") >> applicationPt_;
    sDoFRBMRCoeffs_.lookup("force") >> force_;
    sDoFRBMRCoeffs_.lookup("torque") >> torque_;
    sDoFRBMRCoeffs_.lookup("movePt") >> movePt_;
...
{
    os.writeKeyword("applicationPt") << applicationPt_ << token::END_STATEMENT << nl;
    os.writeKeyword("force") << force_ << token::END_STATEMENT << nl;
    os.writeKeyword("torque") << torque_ << token::END_STATEMENT << nl;
    os.writeKeyword("movePt") << movePt_ << token::END_STATEMENT << nl;
}
